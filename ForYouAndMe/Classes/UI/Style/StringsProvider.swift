...
enum StringKey: String, CaseIterable, CodingKey {
    ...
    case diaryNoteTagMenstrual = "DIARY_NOTE_TAG_MENSTRUAL"
    case diaryNoteMenstrualCellSingleDate = "DIARY_NOTE_MENSTRUAL_CELL_SINGLE_DATE"
    case diaryNoteMenstrualCellDateRange = "DIARY_NOTE_MENSTRUAL_CELL_DATE_RANGE"
