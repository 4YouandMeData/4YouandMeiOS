//
//  HotFlashSuccessViewController.swift
//  ForYouAndMe
//
...
final class HotFlashSuccessViewController: UIViewController {
    ...
    private lazy var footerView: GenericButtonView = {
        ...
        buttonView.setButtonText(StringsProvider.string(forKey: .diaryNoteHotFlashEmojiCloseButton))
    ...
    private func setupUI() {
        ...
        scrollStackView.stackView.addLabel(withText: StringsProvider.string(forKey: .diaryNoteHotFlashEmojiTitle),
                                           fontStyle: .title,
                                           color: ColorPalette.color(withType: .primaryText))

        scrollStackView.stackView.addLabel(withText: StringsProvider.string(forKey: .diaryNoteHotFlashEmojiSubtitle),
                                           fontStyle: .paragraph,
        ...
        if !getEmojis().isEmpty {
            ...
            scrollStackView.stackView.addLabel(
                withText: StringsProvider.string(forKey: .diaryNoteHotFlashEmojiClickMessage),
                fontStyle: .menu,
                colorType: .primaryText)
        }
    ...
    private func getEmojis() -> [EmojiItem] {
        return Services.shared.storageServices.feedbackList[EmojiTagCategory.hotFlash.rawValue] ?? []
    }
}
