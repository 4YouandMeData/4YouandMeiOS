//
//  CaloriesQuestionViewController.swift
//  ForYouAndMe
//
...
protocol CaloriesQuestionViewControllerDelegate: AnyObject {
    /// Called when user confirms the calories answer (Yes/No)
...
class CaloriesQuestionViewController: UIViewController {
    ...
    weak var delegate: CaloriesQuestionViewControllerDelegate?
    ...
    private lazy var yesButton: OptionButton = makeOption(text: isStandalone
                                                          ? StringsProvider.string(forKey: .diaryNoteEatenStepCaloriesQuestionFirstButton)
                                                          : StringsProvider.string(forKey: .noticedStepCaloriesQuestionFirstButton))
    private lazy var noButton: OptionButton = makeOption(text: isStandalone
                                                         ? StringsProvider.string(forKey: .diaryNoteEatenStepCaloriesQuestionSecondButton)
                                                         : StringsProvider.string(forKey: .noticedStepCaloriesQuestionSecondButton))
    ...
    deinit {
        print("CaloriesQuestionViewController - deinit")
    }
    ...
    private func setupLayout() {
        ...
        ? StringsProvider.string(forKey: .diaryNoteEatenStepCaloriesQuestionMessage)
            .replacingPlaceholders(with: [replacementString])
        : StringsProvider.string(forKey: .noticedStepCaloriesQuestionMessage)
            .replacingPlaceholders(with: [replacementString])
        ...
        ? StringsProvider.string(forKey: .diaryNoteEatenStepCaloriesQuestionTitle)
        : StringsProvider.string(forKey: .noticedStepCaloriesQuestionTitle)
    ...
    @objc private func confirmTapped() {
        ...
        delegate?.caloriesQuestionViewController(self, didAnswer: answer)
    }
