//
//  DiaryNoteItemEatenTableViewCell.swift
//  Pods
//
...
class DiaryNoteItemEatenTableViewCell: UITableViewCell {
    ...
    private lazy var noteTagContainer: UIStackView = {
        ...
        container.backgroundColor = UIColor.init(hexString: Constants.Style.EatenColorBackground)
    ...
    private lazy var tagIconImageView: UIImageView = {
        ...
        imageView.image = ImagePalette.templateImage(withName: .eatenIcon)
        imageView.tintColor = UIColor.init(hexString: Constants.Style.EatenColorText)
