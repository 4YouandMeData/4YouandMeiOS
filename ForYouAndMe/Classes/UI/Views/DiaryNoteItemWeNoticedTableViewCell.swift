//
//  DiaryNoteItemWeNoticedTableViewCell.swift
//  Pods
//
...
class DiaryNoteItemWeNoticedTableViewCell: UITableViewCell {
    ...
    private lazy var noteTagContainer: UIStackView = {
        ...
        container.backgroundColor = UIColor.init(hexString: Constants.Style.WeNoticedColorBackground)
    ...
    private lazy var tagIconImageView: UIImageView = {
        ...
        imageView.image = ImagePalette.templateImage(withName: .weNoticedIcon)
        imageView.tintColor = UIColor.init(hexString: Constants.Style.WeNoticedColorText)
    ...
    private lazy var tagLabel: UILabel = {
        let label = UILabel()
        label.text = "We Have Noticed"
        label.font = UIFont.systemFont(ofSize: 8, weight: .medium)
        label.textColor = UIColor.init(hexString: Constants.Style.WeNoticedColorText)
