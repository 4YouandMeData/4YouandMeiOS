...
class ProfilingOptionAnswerCell: UITableViewCell {
    
    typealias ProfilingAnswerCallback = NotificationCallback
    ...
    private var answerPressedCallback: ProfilingAnswerCallback?
    ...
    public func display(data: ProfilingOption, isSelected: Bool, answerPressedCallback: @escaping ProfilingAnswerCallback) {
