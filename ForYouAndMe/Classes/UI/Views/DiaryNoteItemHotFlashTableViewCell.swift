//
//  DiaryNoteItemHotFlashTableViewCell.swift
//  Pods
//
...
/// Cell for displaying "Hot Flash" diary entries
class DiaryNoteItemHotFlashTableViewCell: UITableViewCell {
    ...
    private lazy var noteTagContainer: UIStackView = {
        ...
        container.backgroundColor = UIColor.init(hexString: Constants.Style.HotFlashColorBackground)
    ...
    private lazy var tagIconImageView: UIImageView = {
        ...
        imageView.image = ImagePalette.templateImage(withName: .hotFlashIcon)
        imageView.tintColor = UIColor.init(hexString: Constants.Style.HotFlashColorText)
    ...
    private lazy var tagLabel: UILabel = {
        let label = UILabel()
        label.text = StringsProvider.string(forKey: .diaryNoteTagHotFlash)
        label.font = UIFont.systemFont(ofSize: 8, weight: .medium)
        label.textColor = UIColor.init(hexString: Constants.Style.HotFlashColorText)
